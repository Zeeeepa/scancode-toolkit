.. _contributing-to-docs:

Contributing to the Documentation
=================================

.. _contributing-to-docs-local-setup:
...
.. _contributing-to-docs-docs8-style-checks:
...
.. _contributing-to-docs-interspinx:
...
.. _contributing-to-docs-style-conventions:
...
7. Notes and Warning Snippets
    ...
    Every ``Note`` and ``Warning`` sections are to be kept in ``rst-snippets/note-snippets/`` and
    ``rst-snippets/warning-snippets/`` and then included to eliminate redundancy, as these are
...
See :ref:`supported-packages` for details.
