...
The ScanCode command line onterface has a Help option displaying all the options. It also
...
The following help text is displayed for ScanCode version 32.0.0:
...
.. code-block:: none
  ...
  Options:
    ...
    scan options:
      ...
      --license-url-template URL  Set the template URL used for the license
...
.. _cli-examples-option:

``--examples`` option
---------------------

The ``--examples`` option which displays some basic examples
(more than the basic synopsis in ``--help``).

These examples include the following aspects of code scanning:
...
The following text is displayed for ScanCode version 32.0.0 ::
...
Show the list of available ScanCode plugins.
...
A text similar to below onde is displayed, showing the available plugins for ScanCode Version 32.0.0.
...
.. code-block:: none
  ...
  Plugin: scancode_post_scan:classify  class: summarycode.classify_plugin:FileClassifier
    ...
    required_plugins: 
    options:
      help_group: post-scan, name: classify: --classify
  ...
  Plugin: scancode_post_scan:license-references  class: licensedcode.licenses_reference:LicenseReference
    ...
    options:
      help_group: post-scan, name: license_references: --license-references
        help: Return reference data for all licenses and license rules present in detections.
    doc: 
...
See the :ref:`supported-packages` page for more details and documentation
